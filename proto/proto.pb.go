...
func (x *GrantTokenRequest) GetSenderId() string {
	if x != nil {
		return x.SenderId
	}
	return ""
...
func (x *GrantTokenRequest) GetTimestamp() int64 {
	if x != nil {
		return x.Timestamp
	}
	return 0
...
func (x *GrantTokenResponse) Reset() {
	*x = GrantTokenResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *GrantTokenResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GrantTokenResponse) ProtoMessage() {}

func (x *GrantTokenResponse) ProtoReflect() protoreflect.Message {
	mi := &file_proto_proto_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GrantTokenResponse.ProtoReflect.Descriptor instead.
func (*GrantTokenResponse) Descriptor() ([]byte, []int) {
	return file_proto_proto_proto_rawDescGZIP(), []int{1}
}

func (x *GrantTokenResponse) GetSuccess() bool {
	if x != nil {
		return x.Success
	}
	return false
...
func (x *GrantTokenResponse) GetTimestamp() int64 {
	if x != nil {
		return x.Timestamp
	}
	return 0
...
var file_proto_proto_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x12, 0x05, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x4e, 0x0a, 0x11, 0x47, 0x72,
	...
	0x09, 0x74, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x22, 0x4c, 0x0a, 0x12, 0x47, 0x72,
	0x61, 0x6e, 0x74, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	...
	0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x32, 0x4c, 0x0a, 0x07, 0x53, 0x65, 0x72, 0x76,
	0x69, 0x63, 0x65, 0x12, 0x41, 0x0a, 0x0a, 0x47, 0x72, 0x61, 0x6e, 0x74, 0x54, 0x6f, 0x6b, 0x65,
	0x6e, 0x12, 0x18, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x47, 0x72, 0x61, 0x6e, 0x74, 0x54,
	0x6f, 0x6b, 0x65, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x19, 0x2e, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x2e, 0x47, 0x72, 0x61, 0x6e, 0x74, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x52, 0x65,
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x17, 0x5a, 0x15, 0x68, 0x61, 0x6e, 0x64, 0x2d, 0x69,
...
var file_proto_proto_proto_goTypes = []any{
	(*GrantTokenRequest)(nil),  // 0: proto.GrantTokenRequest
	(*GrantTokenResponse)(nil), // 1: proto.GrantTokenResponse
}
var file_proto_proto_proto_depIdxs = []int32{
	0, // 0: proto.Service.GrantToken:input_type -> proto.GrantTokenRequest
	1, // 1: proto.Service.GrantToken:output_type -> proto.GrantTokenResponse
...
func file_proto_proto_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_proto_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*GrantTokenResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
